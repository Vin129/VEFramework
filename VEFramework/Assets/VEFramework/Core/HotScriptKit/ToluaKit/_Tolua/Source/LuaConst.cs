...
{
    public static string luaDir = Application.dataPath + ScriptBaseSetting.ToLuaKitPath + "_LuaKit/ToLua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + ScriptBaseSetting.ToLuaKitPath + "_Tolua/ToLua/Lua";        //tolua lua文件目录
